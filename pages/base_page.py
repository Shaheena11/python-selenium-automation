...
class Page:
    ...
    def verify_partial_text(self, expected_text, *locator):
        actual_text = self.driver.find_element(*locator).text
        assert actual_text == expected_text,f'Expected {expected_text}, not show actual {actual_text}'
    ...
    def verify_partial_url(self, expected_partial_url):
        current_url = self.driver.current_url
        assert current_url == expected_partial_url, \
            f'Expected URL {expected_partial_url} but got {current_url}'
